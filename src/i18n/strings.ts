...
export const strings = {
  ...
  // Study plan / calendar
  studyPlan: { en: 'Study plan', ja: '学習計画', zh: '学习计划', tr: 'Çalışma planı' },
  todaysPlan: { en: "Today's plan", ja: '今日の学習', zh: '今日计划', tr: 'Bugünün planı' },
  openFullPlan: { en: 'Open full plan', ja: '学習計画を開く', zh: '打开完整计划', tr: 'Tüm planı aç' },
  allDoneToday: { en: 'All done for today 🎉', ja: '今日の学習は完了 🎉', zh: '今日已全部完成 🎉', tr: 'Bugünlük hepsi tamam 🎉' },
  restDay: { en: 'Rest day — review anything you like.', ja: '休息日 — 好きな内容を復習しましょう。', zh: '休息日——复习任何你想复习的内容。', tr: 'Dinlenme günü — istediğini tekrar et.' },
  planToday: { en: 'Today', ja: '今日', zh: '今天', tr: 'Bugün' },
  daysToExamLabel: { en: '{n} days to the EJU', ja: 'EJUまであと{n}日', zh: '距离 EJU 还有 {n} 天', tr: "EJU'ya {n} gün" },
  examDayLabel: { en: 'Exam day!', ja: '試験当日！', zh: '考试日！', tr: 'Sınav günü!' },
  daysComplete: { en: '{done}/{total} days complete', ja: '{done}/{total}日完了', zh: '已完成 {done}/{total} 天', tr: '{done}/{total} gün tamam' },
  phaseLearn: { en: 'Learn & build', ja: '学習と基礎固め', zh: '学习与打基础', tr: 'Öğren ve kur' },
  phaseDrill: { en: 'Drill & master', ja: '演習と定着', zh: '训练与精通', tr: 'Alıştır ve pekiştir' },
  phaseSprint: { en: 'Exam sprint', ja: '直前スパート', zh: '冲刺阶段', tr: 'Sınav sprinti' },
  kindLearn: { en: 'Learn', ja: '学習', zh: '学习', tr: 'Öğren' },
  kindReview: { en: 'Review', ja: '復習', zh: '复习', tr: 'Tekrar' },
  kindDrill: { en: 'Drill', ja: '演習', zh: '训练', tr: 'Alıştırma' },
  kindQuiz: { en: 'Quiz', ja: '小テスト', zh: '测验', tr: 'Sınav' },
  kindMock: { en: 'Mock set', ja: '模擬セット', zh: '模拟卷', tr: 'Deneme' },
  mixedQuiz: { en: 'Mixed {subject} quiz', ja: '{subject}の総合小テスト', zh: '{subject}综合测验', tr: 'Karışık {subject} sınavı' },
  mixedMock: { en: 'Mixed {subject} mock set', ja: '{subject}の総合模擬', zh: '{subject}模拟卷', tr: 'Karışık {subject} deneme' },
  mindmapEmpty: {
