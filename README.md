...
- **Ask Coach** – one tutor chat that does double duty: ask anything about a subject (answers tuned to the EJU syllabus and past‑paper style; memorize‑worthy formulas/facts are auto‑added to your Mindmap), and tap **Check my work** right inside it to have Claude read your handwritten page (vision). The check verdict lands in the same conversation, so you can keep asking follow‑ups about it. If the page clearly shows a final choice for the active question (e.g. a circled **E**), it's recorded as your answer to that question automatically — graded right/wrong — on top of the usual feedback.
- **Mock exams** – review **real past EJU questions with the official answers**, organized by year / session / subject. Pick a paper, answer in‑app (graded instantly), reveal the answer, tap **Explain**, or pin questions to the board. Seeded from your provided past papers (currently **2021 Session 1** across Physics, Chemistry and Biology); the data format takes more papers as they're added.
...
- **Mindmap** – a separate, darker full‑screen mode (toggle at the far left of the bottom bar) that turns the concepts you meet while studying into a per‑subject node graph: a subject hub branches to topic categories you can tap to expand into the individual formulas/facts beneath them. Concepts are auto‑collected from your Coach answers and whiteboard help; pan, zoom and tap to explore, or open the coach from inside it.
